// This component is the extended version of the match component with static data
// I used the api example data to make the component and after I finished realized that the live api doesn't provide the goals and other events
...
export class MatchFullComponent extends MatchComponent implements OnInit {
    matchId = null
    activeTab = 'timeline'
